...
SECRET_KEY = 'django-insecure-lll@divow0-23v0=exh_mxrr4qx9mi-khi&33sm9v0iw&oy1n9'
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'db'),  # 'db' is the name of the service in docker-compose.yml
